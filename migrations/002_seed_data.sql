...
INSERT INTO reservations (room_id, start_date, end_date, user_id, created_at, updated_at)
VALUES
    (1, '2024-05-15', '2024-05-17', 1, NOW(), NOW()),
    (2, '2024-05-20', '2024-05-22', 2, NOW(), NOW()),
    (3, '2024-05-25', '2024-05-27', 3, NOW(), NOW());
